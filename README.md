...
directory does a lot of that for you. You would run it like so:
    ...
    go get github.com/emaincourt/oapi-codegen/cmd/oapi-codegen
...
```
    import (
        "github.com/emaincourt/oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/emaincourt/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  - skip-prune
import-mapping:
  ./packageA/spec.yaml: github.com/emaincourt/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/emaincourt/oapi-codegen/internal/test/externalref/packageB
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/emaincourt/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48)
